...
class _$_CartUpdate implements _CartUpdate {
  ...
  @override
  String toString() {
    return 'CartUpdate(productId: $productId, cityFias: $cityFias, count: $count)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, productId, cityFias, count);
...
abstract class _CartUpdate implements CartUpdate {
  factory _CartUpdate(
      ...
      @JsonKey(name: 'count') final int? count}) = _$_CartUpdate;
